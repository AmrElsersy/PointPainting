...
def main(args):
    ...
    out_video = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*'mp4v'), FPS, frame_shape)
    for frame in frames:
...
if __name__ == '__main__':
    ...
    default='Videos/2/2011_09_26_drive_0106_sync/2011_09_26')
